...
func selectOneMachine(ctx context.Context, machineID string, haveMachineID bool) (*api.Machine, context.Context, error) {
	return selectOneMachineImpl(ctx, machineID, haveMachineID, nil)
}

func selectOneMachineFromApp(ctx context.Context, machineID string, haveMachineID bool, app *api.AppCompact) (*api.Machine, context.Context, error) {
	if app == nil {
		return nil, nil, errors.New("tried to select a machine from a nil app; this is a bug")
	}
	return selectOneMachineImpl(ctx, machineID, haveMachineID, app)
}

func selectOneMachineImpl(ctx context.Context, machineID string, haveMachineID bool, app *api.AppCompact) (*api.Machine, context.Context, error) {
	var err error
